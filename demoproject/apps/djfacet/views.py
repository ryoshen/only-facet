...
def __extractGETparams(request):
    ...
    showonly_subs = request.GET.get('showsubs',
                                    None) #in single_facet, means that we're zooming into a specific filter-values
    ...
    return [page, resulttype, ordering, query_filtersUrl, query_filtersBuffer, activeIDs, item, totitems, showonly_subs,
            history]
